...
/**
 * Use floats to restore the coords of a 2D vector to improve the performance.
 * <p>
 * Used Mainly for {@link mindustry.entities.Effect} that need a cached sequence
 * of vec2s to avoid constructing too much {@link Vec2} instances.
 * <p>
