...
public class ArcCharge extends DrawPart {
    ...
    public void draw(PartParams params) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            Draw.rect(JBContent.arrowRegion, Tmp.v1.x, Tmp.v1.y, JBContent.arrowRegion.width * Draw.scl * fin_9, JBContent.arrowRegion.height * Draw.scl * fin_9, rot + 90);
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            Draw.rect(JBContent.pointerRegion, Tmp.v1.x, Tmp.v1.y, JBContent.pointerRegion.width * Draw.scl * fin_9, JBContent.pointerRegion.height * Draw.scl * fin_9, rot + 90);
        }
